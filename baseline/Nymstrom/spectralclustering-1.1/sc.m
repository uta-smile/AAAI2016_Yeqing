function [cluster_labels evd_time kmeans_time total_time] = sc(A, sigma, num_clusters, trans_sim)
...
cluster_labels = litekmeans(double(U), num_clusters);
total_time = toc;
